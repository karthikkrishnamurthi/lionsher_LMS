...
#      format.json { head :no_content }
  ...
  # This code will be executed once to fill the difficulty table. This will be same for all tenants
  def create_difficulties
    d = Difficulty.find_by_difficulty_value("very low")
    if d.nil? or d.blank?
      difficulty = Difficulty.new
      difficulty.difficulty_value = "very low"
      difficulty.save
      difficulty = Difficulty.new
      difficulty.difficulty_value = "low"
      difficulty.save
      difficulty = Difficulty.new
      difficulty.difficulty_value = "medium"
      difficulty.save
      difficulty = Difficulty.new
      difficulty.difficulty_value = "difficult"
      difficulty.save
      difficulty = Difficulty.new
      difficulty.difficulty_value = "very difficult"
      difficulty.save
      difficulty = Difficulty.new
      difficulty.difficulty_value = "not defined"
      difficulty.save
    end
  end
