class CalculatedDataAssessmentsController < ApplicationController
  # GET /calculated_data_assessments
  # GET /calculated_data_assessments.json
  def index
    @calculated_data_assessments = CalculatedDataAssessment.all

    respond_to do |format|
      format.html # index.html.erb
      format.json { render json: @calculated_data_assessments }
    end
  end

  # GET /calculated_data_assessments/1
  # GET /calculated_data_assessments/1.json
  def show
  ...
  # GET /calculated_data_assessments/new
  # GET /calculated_data_assessments/new.json
  def new
  ...
  # GET /calculated_data_assessments/1/edit
  def edit
    @calculated_data_assessment = CalculatedDataAssessment.find(params[:id])
  end

  # POST /calculated_data_assessments
  # POST /calculated_data_assessments.json
  def create
  ...
  # PUT /calculated_data_assessments/1
  # PUT /calculated_data_assessments/1.json
  def update
    @calculated_data_assessment = CalculatedDataAssessment.find(params[:id])
  ...
  # DELETE /calculated_data_assessments/1
  # DELETE /calculated_data_assessments/1.json
  def destroy
    @calculated_data_assessment = CalculatedDataAssessment.find(params[:id])
